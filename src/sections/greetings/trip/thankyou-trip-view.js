...
export default function ThankyouTripView({ title, desc }) {
  ...
  const renderHead = (
    <Stack alignItems="center" justifyContent="center">
      ...
      <Typography variant="h4" sx={{ mb: 1 }}>
        Terima kasih telah mengajukan permintaan trip!
      </Typography>

      <Stack spacing={1} alignItems="center" justifyContent="center" sx={{ color: "text.secondary", typography: "body2", mb: 5 }}>
        <Box component="span"> Tim kami sedang memproses detail permintaan dan akan menghubungi Kamu dalam waktu maksimal 2x24 jam untuk konfirmasi lebih lanjut. </Box>
