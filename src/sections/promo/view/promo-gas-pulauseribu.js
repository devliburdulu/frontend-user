...
const mockBanner = [
  {
    id: 1,
    coverUrl: "/qwev_tArtboard_3.webp",
    title: "banner-pulauseribu",
  },
  // {
  //   id: 2,
...
export default function PromoGasPulauSeribuView() {
    const [title, setTitle] = useState('Promo: Open Trip Pulau Seribu'+ ' - Liburdulu.id');
  ...
  const [filter, setFilter] = useState({
    ...
    categoryId: typeof localStorage !== "undefined" ? 59 : 59,
    search: "",
    maxPrice: -1,
    minPrice: -1,
    page: 1,
