...
const mockBanner = [
  // {
  //   id: 1,
  //   coverUrl: "/banner-promo-diskon22.png",
  //   title: "banner-promo-diskon22",
  // },
  {
    id: 2,
    coverUrl: "/qwev_tArtboard_2.webp",
    title: "banner-promo22persen",
  },
  // {
  //   id: 3,
...
export default function PromoDiskon22View() {
  const [title, setTitle] = useState('Promo: Diskon 22%'+ ' - Liburdulu.id');
  ...
  const [filter, setFilter] = useState({
    ...
    categoryId: typeof localStorage !== "undefined" ? 56 : 56,
    search: "",
    maxPrice: -1,
    minPrice: -1,
    page: 1,
