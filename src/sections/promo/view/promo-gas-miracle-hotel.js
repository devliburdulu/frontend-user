...
const mockBanner = [
  {
    id: 1,
    coverUrl: "/qwev_tArtboard_4.webp",
    title: "banner-mirachel",
  },
  // {
  //   id: 2,
...
export default function PromoGasMirachelHotelView() {
  const [title, setTitle] = useState('Promo: Mirachel Hotel Management'+ ' - Liburdulu.id');
  ...
  const [filter, setFilter] = useState({
    ...
    categoryId: typeof localStorage !== "undefined" ? 60 : 60,
    search: "",
    maxPrice: -1,
    minPrice: -1,
    page: 1,
