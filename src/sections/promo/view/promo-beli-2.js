...
const mockBanner = [
  {
    id: 1,
    coverUrl: "/banner-promo-beli2.png",
    title: "banner-promo-beli2",
  },
  // {
  //   id: 2,
...
export default function PromoBeli2View() {
  const [title, setTitle] = useState('Promo: Beli 2 Gratis 2'+ ' - Liburdulu.id');
  ...
  const [filter, setFilter] = useState({
    ...
    categoryId: typeof localStorage !== "undefined" ? 57 : 57,
    search: "",
    maxPrice: -1,
    minPrice: -1,
    page: 1,
