...
export const ORDER_STATUS_OPTIONS = [
  ...
  { value: 'waiting_for_approval', label: 'Konfirmasi Pembelian' },
  { value: 'processing', label: 'Diproses' },
  { value: 'complete', label: 'Selesai' },
  { value: 'order_canceled_pending', label: 'Konfirmasi Pembatalan' },
  { value: 'canceled', label: 'Dibatalkan' },
  { value: 'order_reject', label: 'Ditolak' },
  { value: 'partial_payment', label: 'Down Payment' },
];
