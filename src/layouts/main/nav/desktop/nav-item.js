...
export const NavItem = forwardRef(({ title, path, open, active, hasChild, externalLink, onClick, subItem, ...other }, ref) => {
  ...
  const renderContent = (
    <StyledNavItem disableRipple disableTouchRipple ref={ref} onClick={handleClick} open={open} active={active} subItem={subItem} {...other}>
      {title}
